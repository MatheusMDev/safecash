...
class FaceRecognitionScreenFail extends StatefulWidget {
  const FaceRecognitionScreenFail({super.key});

  @override
  State<FaceRecognitionScreenFail> createState() =>
      _FaceRecognitionScreenFailState();
}

class _FaceRecognitionScreenFailState extends State<FaceRecognitionScreenFail> {
  @override
  void initState() {
    super.initState();
