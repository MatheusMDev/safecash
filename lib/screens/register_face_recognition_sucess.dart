...
class FaceRecognitionScreenSucess extends StatefulWidget {
  const FaceRecognitionScreenSucess({super.key});

  @override
  State<FaceRecognitionScreenSucess> createState() =>
      _FaceRecognitionScreenSucessState();
}

class _FaceRecognitionScreenSucessState
    extends State<FaceRecognitionScreenSucess> {
  @override
  void initState() {
    super.initState();
