import 'dart:convert';
import 'package:bank_app/screens/pix_face_recognition_fail.dart';
import 'package:bank_app/screens/pix_face_recognition_sucess.dart';
import 'package:bank_app/widgets/create_user.dart';
import 'package:camera/camera.dart';
import 'package:flutter/material.dart';
import 'package:bank_app/services/api.dart';

class PixFaceRecognitionScreen extends StatefulWidget {
  const PixFaceRecognitionScreen({super.key, this.cpf, this.uid});
    ...
    try {
      ...
      if (success) {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (_) => const PixFaceRecognitionSucess(),
          ),
        );
      } else {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (_) => const PixFaceRecognitionFail(),
          ),
        );
      }
    } catch (e) {
